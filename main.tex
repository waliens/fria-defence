...
\begin{frame}{Objectifs}
	...
	\begin{enumerate}
		\item How to \textbf{integrate human operators to the learning process} in order to improve its performances ?
		\item How to \textbf{leverage any available auxiliary data} for reaching the same goal ? 
	\end{enumerate}
...
\begin{frame}{Question 2: auxiliary data ?}
